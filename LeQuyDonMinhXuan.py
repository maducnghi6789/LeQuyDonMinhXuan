...
# ==========================================
# 4. MODULE AI KHẢO THÍ (CẬP NHẬT TỰ ĐỘNG ĐẢO MODEL)
# ==========================================
...
def take_exam_ui(exam_data, exam_id, is_mandatory=True, is_review=False, user_ans_data=None):
    ...
    if is_review and user_ans_data:
        ...
        col1.metric("📌 ĐIỂM SỐ", f"{score} / 10")
...
# ==========================================
def main():
    st.set_page_config(page_title="LMS Lê Quý Đôn V30", layout="wide")
    init_db()
    
    if 'current_user' not in st.session_state:
        st.markdown("<h2 style='text-align: center;'>🎓 HỆ THỐNG LMS LÊ QUÝ ĐÔN V30</h2>", unsafe_allow_html=True)
